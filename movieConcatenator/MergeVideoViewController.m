...
- (IBAction)mergeAndSave:(id)sender
{
    if (self.firstAsset !=nil && self.secondAsset!=nil)
    {
        ...
        //// 2.0.Aa
        /// first video and audio composition tracks
        ...
        /// 2.0.B a add first audio track to composition:
        
        //AVMutableCompositionTrack *firstAudioTrack = [mixComposition addMutableTrackWithMediaType:AVMediaTypeAudio preferredTrackID:kCMPersistentTrackID_Invalid];
        
       // [firstAudioTrack insertTimeRange:CMTimeRangeMake(kCMTimeZero, self.firstAsset.duration) ofTrack:[[self.firstAsset tracksWithMediaType:AVMediaTypeAudio] objectAtIndex:0] atTime:kCMTimeZero error:nil];
        
        ///2.0.Bb add second audio track to composition:
        
        //AVMutableCompositionTrack *secondAudioTrack = [mixComposition addMutableTrackWithMediaType:AVMediaTypeAudio preferredTrackID:kCMPersistentTrackID_Invalid];
        
        //[secondAudioTrack insertTimeRange:CMTimeRangeMake(kCMTimeZero, self.secondAsset.duration) ofTrack:[[self.secondAsset tracksWithMediaType:AVMediaTypeAudio] objectAtIndex:0] atTime:self.firstAsset.duration error:nil];
        ...
        // first video asset track
        AVAssetTrack *firstAssetTrack = [[self.firstAsset tracksWithMediaType:AVMediaTypeVideo] objectAtIndex:0];
        [firstTrack insertTimeRange:CMTimeRangeMake(kCMTimeZero, self.firstAsset.duration) ofTrack:firstAssetTrack atTime:kCMTimeZero error:nil];
        // first audio asset track
        AVAssetTrack *firstAudioAssetTrack = [[self.firstAsset tracksWithMediaType:AVMediaTypeAudio] objectAtIndex:0];
        [firstAudioTrack insertTimeRange:CMTimeRangeMake(kCMTimeZero, self.firstAsset.duration) ofTrack:firstAudioAssetTrack atTime:kCMTimeZero error:nil];
        ...
        // second video asset track
        AVAssetTrack *secondAssetTrack = [[self.secondAsset tracksWithMediaType:AVMediaTypeVideo] objectAtIndex:0];
        [secondTrack insertTimeRange:CMTimeRangeMake(kCMTimeZero, self.secondAsset.duration) ofTrack:secondAssetTrack atTime:self.firstAsset.duration error:nil];
        //second audio asset track
        AVAssetTrack *secondAudioAssetTrack = [[self.secondAsset tracksWithMediaType:AVMediaTypeAudio] firstObject];
        [secondAudioTrack insertTimeRange:CMTimeRangeMake(kCMTimeZero, self.secondAsset.duration) ofTrack: secondAudioAssetTrack atTime:self.firstAsset.duration error:nil];
        ...
        if (audioAsset!=nil){
         ...
         /// add first audio track to composition:
         
         AVMutableCompositionTrack *firstAudioTrack = [mixComposition addMutableTrackWithMediaType:AVMediaTypeAudio
         preferredTrackID:kCMPersistentTrackID_Invalid];
         
         [firstAudioTrack insertTimeRange:CMTimeRangeMake(kCMTimeZero, self.firstAsset.duration)
         ofTrack:[[self.firstAsset tracksWithMediaType:AVMediaTypeAudio] objectAtIndex:0] atTime:kCMTimeZero error:nil];
         
         /// add second audio track to composition:
         
         AVMutableCompositionTrack *secondAudioTrack = [mixComposition addMutableTrackWithMediaType:AVMediaTypeAudio
         preferredTrackID:kCMPersistentTrackID_Invalid];
         
         [secondAudioTrack insertTimeRange:CMTimeRangeMake(kCMTimeZero, self.secondAsset.duration)
         ofTrack:[[self.secondAsset tracksWithMediaType:AVMediaTypeAudio] objectAtIndex:0] atTime:self.firstAsset.duration error:nil];
